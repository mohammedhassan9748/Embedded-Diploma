...
static GPIO_PinConfig_t g__7_SEGMENT_A = {_7_SEGMENT_A_PORT,_7_SEGMENT_A_PIN,GPIO_MODE_OUTPUT_PP,GPIO_OUTPUT_SPEED_10MHZ};
static GPIO_PinConfig_t g__7_SEGMENT_B = {_7_SEGMENT_B_PORT,_7_SEGMENT_B_PIN,GPIO_MODE_OUTPUT_PP,GPIO_OUTPUT_SPEED_10MHZ};
static GPIO_PinConfig_t g__7_SEGMENT_C = {_7_SEGMENT_C_PORT,_7_SEGMENT_C_PIN,GPIO_MODE_OUTPUT_PP,GPIO_OUTPUT_SPEED_10MHZ};
static GPIO_PinConfig_t g__7_SEGMENT_D = {_7_SEGMENT_D_PORT,_7_SEGMENT_D_PIN,GPIO_MODE_OUTPUT_PP,GPIO_OUTPUT_SPEED_10MHZ};
static GPIO_PinConfig_t g__7_SEGMENT_E = {_7_SEGMENT_E_PORT,_7_SEGMENT_E_PIN,GPIO_MODE_OUTPUT_PP,GPIO_OUTPUT_SPEED_10MHZ};
static GPIO_PinConfig_t g__7_SEGMENT_F = {_7_SEGMENT_F_PORT,_7_SEGMENT_F_PIN,GPIO_MODE_OUTPUT_PP,GPIO_OUTPUT_SPEED_10MHZ};
static GPIO_PinConfig_t g__7_SEGMENT_G = {_7_SEGMENT_G_PORT,_7_SEGMENT_G_PIN,GPIO_MODE_OUTPUT_PP,GPIO_OUTPUT_SPEED_10MHZ};
