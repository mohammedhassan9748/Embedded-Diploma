...
#define NVIC_ISER0			*(vuint32_t_*)(NVIC_BASE+0x000)
#define NVIC_ISER1			*(vuint32_t_*)(NVIC_BASE+0x004)
#define NVIC_ISER2			*(vuint32_t_*)(NVIC_BASE+0x008)
#define NVIC_ICER0			*(vuint32_t_*)(NVIC_BASE+0x080)
#define NVIC_ICER1			*(vuint32_t_*)(NVIC_BASE+0x084)
#define NVIC_ICER2			*(vuint32_t_*)(NVIC_BASE+0x088)
#define NVIC_ISPR0			*(vuint32_t_*)(NVIC_BASE+0x100)
#define NVIC_ISPR1			*(vuint32_t_*)(NVIC_BASE+0x104)
#define NVIC_ISPR2			*(vuint32_t_*)(NVIC_BASE+0x108)
#define NVIC_ICPR0			*(vuint32_t_*)(NVIC_BASE+0x180)
#define NVIC_ICPR1			*(vuint32_t_*)(NVIC_BASE+0x184)
#define NVIC_ICPR2			*(vuint32_t_*)(NVIC_BASE+0x188)
#define NVIC_IABR0			*(vuint32_t_*)(NVIC_BASE+0x200)
#define NVIC_IABR1			*(vuint32_t_*)(NVIC_BASE+0x204)
#define NVIC_IABR2			*(vuint32_t_*)(NVIC_BASE+0x208)

				/* RCC */
				/*-----*/
typedef struct{
	vuint32_t_ CR;			// 0x00
	vuint32_t_ CFGR;			// 0x04
	vuint32_t_ CIR;			// 0x08
	vuint32_t_ APB2RSTR;		// 0x0C
	vuint32_t_ APB1RSTR;		// 0x10
	vuint32_t_ AHBENR;		// 0x14
	vuint32_t_ APB2ENR;		// 0x18
	vuint32_t_ APB1ENR;		// 0x1C
	vuint32_t_ BDCR;			// 0x20
	vuint32_t_ CSR;			// 0x24
}RCC_Typedef;
				...
				/*------*/
typedef struct{
	vuint32_t_ EVCR;			// 0x00
	vuint32_t_ MAPR;			// 0x04
	vuint32_t_ EXTICR[4];	// 0x08 0x0C 0x10 0x14
	vuint32_t_ RESERVED;		// 0x18
	vuint32_t_ MAPR2;		// 0x1C
}AFIO_Typedef;
...
typedef struct{
	vuint32_t_ IMR;			// 0x00
	vuint32_t_ EMR;			// 0x04
	vuint32_t_ RTSR;			// 0x08
	vuint32_t_ FTSR;			// 0x08
	vuint32_t_ SWIER;		// 0x0C
	vuint32_t_ PR;			// 0x10
}EXTI_Typedef;
...
typedef struct{
	...
	vuint32_t_ IDR;			// 0x08
	vuint32_t_ ODR;			// 0x0C
	vuint32_t_ BSRR;			// 0x10
	vuint32_t_ BRR;			// 0x14
	vuint32_t_ LCKR;			// 0x18
}GPIO_Typedef;
...
typedef struct{
	vuint32_t_ CR1;			// 0x00
	vuint32_t_ CR2; 			// 0x04
	vuint32_t_ SMCR;			// 0x08
	vuint32_t_ DIER;			// 0x0C
	vuint32_t_ SR;			// 0x10
	vuint32_t_ EGR;			// 0x14
	vuint32_t_ CCMR[2];		// 0x18 - 0x1C
	vuint32_t_ CCER;			// 0x20
	vuint32_t_ CNT;			// 0x24
	vuint32_t_ PSC; 			// 0x28
	vuint32_t_ ARR;			// 0x2C
	vuint32_t_ RESERVED1;	// 0x30
	vuint32_t_ CCR[4];		// 0x34 - 0x40
	vuint32_t_ RESERVED2;	// 0x44
	vuint32_t_ DCR;			// 0x48
	vuint32_t_ DMAR;			// 0x4C
}GPTM_Typedef;
...
typedef struct{
	...
	vuint32_t_ SR;			// 0x08
	vuint32_t_ DR;			// 0x0C
	vuint32_t_ CRCPR;		// 0x10
	vuint32_t_ RXCRCR;		// 0x14
	vuint32_t_ TXCRCR;		// 0x18
	vuint32_t_ I2SCFGR;		// 0x1C
	vuint32_t_ I2SPR;		// 0x20
}SPI_Typedef;
...
typedef struct{
	vuint32_t_ CR1;			// 0x00
	vuint32_t_ CR2; 			// 0x04
	vuint32_t_ OAR1;			// 0x08
	vuint32_t_ OAR2;			// 0x0C
	vuint32_t_ DR;			// 0x10
	vuint32_t_ SR1;			// 0x14
	vuint32_t_ SR2;			// 0x18
	vuint32_t_ CCR;			// 0x1C
	vuint32_t_ TRISE;		// 0x20
}I2C_Typedef;
