...
void MCAL_I2C_Init(I2C_Config_t* I2C_ConfigPtr){
	...
	uint32_t_ I2Cx_PCLK1_temp__MHZ = 0;
	...
	if(I2C_ConfigPtr->I2C_PeripheralMode == I2C_MODE_I2C)
	{
		 ...
		 */
		uint32_t_ CCR_Value = ((I2Cx_PCLK1_temp__MHZ*1000000) / (I2C_ConfigPtr->I2C_SCLK<<1)) ;
...
void MCAL_I2C_MasterTxPolling(I2C_Config_t* I2C_ConfigPtr, uint16_t devAddress, uint8_t* pTxBuffer,
		uint32_t_ dataLength, I2C_Start_Condition_t startCondition,I2C_Stop_Condition_t stopCondition)
{
