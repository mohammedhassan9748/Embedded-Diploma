 ...
 * *********************************************
*/
#define I2C_SCLK_10KHZ						(uint32_t_)(10000)
#define I2C_SCLK_20KHZ						(uint32_t_)(20000)
#define I2C_SCLK_30KHZ						(uint32_t_)(30000)
#define I2C_SCLK_40KHZ						(uint32_t_)(40000)
#define I2C_SCLK_50KHZ						(uint32_t_)(50000)
#define I2C_SCLK_60KHZ						(uint32_t_)(60000)
#define I2C_SCLK_70KHZ						(uint32_t_)(70000)
#define I2C_SCLK_80KHZ						(uint32_t_)(80000)
#define I2C_SCLK_90KHZ						(uint32_t_)(90000)
#define I2C_SCLK_100KHZ						(uint32_t_)(100000)
#define I2C_SCLK_150KHZ___FM_ONLY			(uint32_t_)(150000)
#define I2C_SCLK_200KHZ___FM_ONLY			(uint32_t_)(200000)
#define I2C_SCLK_250KHZ___FM_ONLY			(uint32_t_)(250000)
#define I2C_SCLK_300KHZ___FM_ONLY			(uint32_t_)(300000)
#define I2C_SCLK_350KHZ___FM_ONLY			(uint32_t_)(350000)
#define I2C_SCLK_400KHZ___FM_ONLY			(uint32_t_)(400000)
...
typedef struct{
	...
	uint32_t_ I2C_SCLK;  					// Specifies the SCL pin clock frquency and Thigh & Tlow.
...
void MCAL_I2C_MasterSendDataPolling(I2C_Config_t* I2C_ConfigPtr, uint8_t* pTxBuffer, uint32_t_ dataLength);

// Master Receiving/Reading only using polling technique API *Note used for whole sequence*
void MCAL_I2C_MasterRecDataPolling (I2C_Config_t* I2C_ConfigPtr, uint8_t* pRxBuffer, uint32_t_ dataLength,
		I2C_Stop_Condition_t stopCondition);

// Master Sending/Writing whole sequence using polling technique only API
void MCAL_I2C_MasterTxPolling(I2C_Config_t* I2C_ConfigPtr, uint16_t devAddress, uint8_t* pTxBuffer, uint32_t_ dataLength,
...
void MCAL_I2C_MasterRxPolling(I2C_Config_t* I2C_ConfigPtr, uint16_t devAddress, uint8_t* pRxBuffer, uint32_t_ dataLength,
		I2C_Start_Condition_t startCondition, I2C_Stop_Condition_t stopCondition);
