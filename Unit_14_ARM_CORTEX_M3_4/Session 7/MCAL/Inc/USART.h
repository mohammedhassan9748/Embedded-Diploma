...
*/
#define USART_MODE_TX					(uint32_t_)(1<<3)			// Bit 3 TE:  Transmitter enable
#define USART_MODE_RX					(uint32_t_)(1<<2) 			// Bit 2 RE:  Receiver enable
#define USART_MODE_TX_RX				(uint32_t_)((1<<2)|(1<<3))	// Bit [3:2]: Transmitter & Receiver enable
...
*/
#define USART_BAUDRATE_2400				(uint32_t_)2400
#define USART_BAUDRATE_9600				(uint32_t_)9600
#define USART_BAUDRATE_19200			(uint32_t_)19200
#define USART_BAUDRATE_57600			(uint32_t_)57600
#define USART_BAUDRATE_115200			(uint32_t_)115200
#define USART_BAUDRATE_230400			(uint32_t_)230400
#define USART_BAUDRATE_460800			(uint32_t_)460800
#define USART_BAUDRATE_921600			(uint32_t_)921600
#define USART_BAUDRATE_2250000			(uint32_t_)2250000
#define USART_BAUDRATE_4500000			(uint32_t_)4500000
...
*/
#define USART_WORD_LENGTH_8				(uint32_t_)(0<<12)
#define USART_WORD_LENGTH_9				(uint32_t_)(1<<12)
...
2: USART_PARITY_ODD
*/
#define USART_PARITY_DISABLE			(uint32_t_)(0<<10)
#define USART_PARITY_EVEN				(uint32_t_)(1<<10)
#define USART_PARITY_ODD				(uint32_t_)((1<<9)|(1<<10))
...
*/
#define USART_STOP_BIT_1				(uint32_t_)(0<<12)
#define USART_STOP_BIT_0_5				(uint32_t_)(1<<12)
#define USART_STOP_BIT_2				(uint32_t_)(2<<12)
#define USART_STOP_BIT_1_5				(uint32_t_)(3<<12)
...
*/
#define USART_FLOW_CONTROL_DISABLE		(uint32_t_)(0)
#define USART_FLOW_CONTROL_RTS			(uint32_t_)(1<<8)
#define USART_FLOW_CONTROL_CTS			(uint32_t_)(1<<9)
#define USART_FLOW_CONTROL_RTS_CTS		(uint32_t_)((1<<8)|(1<<9))
...
5: USART_IE_PE
*/
#define USART_IE_DISABLE				(uint32_t_)(0)
#define USART_IE_TXE					(uint32_t_)(1<<7) 	// Transmitter Empty interrupt enable
#define USART_IE_TXC					(uint32_t_)(1<<6)	// Transmit Complete interrupt enable
#define USART_IE_RXNE					(uint32_t_)(1<<5)	// Receive Not Empty interrupt enable
#define USART_IE_PE						(uint32_t_)(1<<8)	// Parity Error interrupt enable
...
typedef struct{
	...
	uint32_t_ USART_Mode;  			// Specifies the TX/RX Enable or Disable.
							  	  	// This parameter must be a value of @ref USART_Mode_Define.

	uint32_t_ USART_BaudRate;  		// Specifies the Baud Rate for the USART Communication.
						  	  	    // This parameter must be a value of @ref USART_BaudRate_Define.

	uint32_t_  USART_WordLength;   	// Specifies the number of data bits transmitted or received in a frame.
						  	  	  	// This parameter must be a value of @ref USART_WordLength_Define.

	uint32_t_  USART_Parity;   		// Specifies the parity bit.
								    // This parameter must be a value of @ref USART_Parity_Define.

	uint32_t_  USART_StopBits;   		// Specifies the number of stop bits transmitted or received in a frame.
								    // This parameter must be a value of @ref USART_StopBits_Define.

	uint32_t_  USART_FlowControl;   	// Specifies the flow control (RTS/CTS) Enable or Disable.
								    // This parameter must be a value of @ref USART_FlowControl_Define.

	uint32_t_  USART_IRQ_EN;   		// Enable or Disable IRQ for TX/RX - PR - TC.
